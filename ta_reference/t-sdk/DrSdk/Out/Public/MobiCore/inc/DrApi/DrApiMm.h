...
/*#define MAP_RESERVED_5          (1U << 5)*/
/*#define MAP_RESERVED_6          (1U << 6)*/

#define MAP_NOT_SECURE          (1U << 7) /**< mapping gives the ability to set Non-Secure attribute (Mutual exclusive with MAP_EXECUTABLE).
                                               Warning : 1/ the memory which is mapped using this flag is Non-Secure and as such must not be trusted,
                                                         this flag shall be used carefully.
                                                         2/ this attribute is used to map physical buffers only */
#define MAP_ALLOW_NONSECURE     (1U << 7) /**< mapping may have not-secure attribute set.
                                               Warning: this attribute is used only to map client task buffers using drApiMapTaskBuffer function */
#define MAP_STRONGLY_ORDERED    (1U << 8) /**< mapping gives the ability to access memory with the Strongly Ordered attribute. */
...
#define DRAPI_PHYS_MEM_TYPE_HIGH_SECURE   (1U<<0)                  /**< Deprecated, DRAPI_PHYS_MEM_TYPE_SECURE is returned instead */
