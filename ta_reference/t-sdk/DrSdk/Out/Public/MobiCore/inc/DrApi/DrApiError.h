...
#define E_DRAPI_NOT_ENOUGH_MEMORY       0xF0A    /**< Not enough dynamic memory to map a buffer*/
#define E_DRAPI_WRONG_PERMISSIONS       0xF0B    /**< Requested permisions are not correct or don't match with client ones */
#define E_DRAPI_VA_SPACE_LIMIT          0xF0C    /**< Task virtual address space limit has been achieved*/
#define E_DRAPI_PHYSICAL_MEMORY_LIMIT   0xF0D    /**< No more physical pages available */
#define E_DRAPI_MMU_TABLE_LIMIT         0xF0E    /**< No more MMU tables available*/
#endif // #if TBASE_API_LEVEL >= 5
