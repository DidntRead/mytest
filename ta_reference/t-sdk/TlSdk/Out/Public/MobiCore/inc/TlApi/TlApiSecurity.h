...
static _UNUSED inline tlApiResult_t tlApiWrapObject(
    const void *src,
    size_t plainLen,
    size_t encryptedLen,
    void *dest,
...
static _UNUSED inline tlApiResult_t tlApiUnwrapObject(
    void *src,
    size_t srcLen,
    void *dest,
    size_t *destLen,
 ...
 *             is unique to the container of the TA calling this function
 *
 * @return TLAPI_OK if operation was successful.
 */
